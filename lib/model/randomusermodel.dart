...
class Randomusermodel {
  ...
  // factory Randomusermodel.fromJson(String source) => Randomusermodel.fromMap(json.decode(source));

  @override
  String toString() => 'Randomusermodel(results: $results, info: $info)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is Randomusermodel &&
